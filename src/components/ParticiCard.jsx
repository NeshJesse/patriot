...
import { UserPlus, Mail, Phone, Trash2, CheckCircle, Camera, Edit3 } from 'lucide-react'; // Importing icons
...
const ParticiCard = ({ onNext }) => {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white shadow-md rounded-md space-y-6">
            ...
            {participants.map((participant, index) => (
              <li key={index} className="flex justify-between items-center bg-gray-100 p-2 rounded-md">
                ...
                <div className="flex space-x-2">
                  <button
                    onClick={() => setFormVisible(true)} // Show form for editing
      ...
      {!formVisible && (
        <button
          onClick={() => setFormVisible(true)} // Toggle form visibility
          className="w-full py-2 mt-4 bg-purple-500 text-white rounded-md hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
        >
