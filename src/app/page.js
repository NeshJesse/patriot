    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <Image
          ...
          src="/images/protest-logo.png" // Replace with your app's logo or an image relevant to peaceful protest
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            ...
            href="/create" // Link to event creation page
          >
            Get Started
          </a>
          <a
            ...
            href="/learn-more" // Link to more information
          >
            Learn More
          </a>
        </div>
      ...
      <footer className="row-start-3 flex gap-6 flex-wrap items-center justify-center">
        <a
          ...
          href="https://humanrights.org" // Replace with a relevant human rights website
          target="_blank"
          rel="noopener noreferrer"
        >
          <Image
            aria-hidden
            src="/images/human-rights.svg" // Replace with a relevant icon
        ...
        <a
          className="flex items-center gap-2 hover:underline hover:underline-offset-4"
          href="https://nonviolence.org" // Replace with a relevant non-violence organization
          target="_blank"
          rel="noopener noreferrer"
        >
          <Image
            aria-hidden
            src="/images/nonviolence.svg" // Replace with a relevant icon
        ...
        <a
          className="flex items-center gap-2 hover:underline hover:underline-offset-4"
          href="https://nextjs.org" // Or any other relevant external link
          target="_blank"
          rel="noopener noreferrer"
        >
          <Image
            aria-hidden
            src="/images/globe.svg" // Use a globe or any relevant icon
            alt="Globe Icon"
            width={16}
            height={16}
          />
          Explore Global Protests
        </a>
      </footer>
    </div>
  );
